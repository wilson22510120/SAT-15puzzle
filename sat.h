...
class SatSolver
{
   public : 
      ...
      void addAigCNFnoF(Var va, bool fa) {
         vec<Lit> lits;
         Lit la = fa? ~Lit(va): Lit(va);
         lits.push(la); 
         _solver->addClause(lits); lits.clear();
      ...
      // (f == a + b)
      void addCNF(Var vf, Var va, bool fa, Var vb, bool fb) {
         vec<Lit> lits;
         Lit lf = Lit(vf);
         Lit la = fa? ~Lit(va): Lit(va);
         Lit lb = fb? ~Lit(vb): Lit(vb);
      ...
      // (a + b)
      void addCNFnoF(Var va, bool fa, Var vb, bool fb) {
         vec<Lit> lits;
         Lit la = fa? ~Lit(va): Lit(va);
         Lit lb = fb? ~Lit(vb): Lit(vb);
      ...
      void addCNF3(Var vf, Var va, bool fa, Var vb, bool fb,Var vc, bool fc) {
         vec<Lit> lits;
         Lit lf = Lit(vf);
         Lit la = fa? ~Lit(va): Lit(va);
         Lit lb = fb? ~Lit(vb): Lit(vb);
       ...
       void addCNF3noF(Var va, bool fa, Var vb, bool fb,Var vc, bool fc) {
         vec<Lit> lits;
         Lit la = fa? ~Lit(va): Lit(va);
         Lit lb = fb? ~Lit(vb): Lit(vb);
         Lit lc = fc? ~Lit(vc): Lit(vc);
      ...
      void addCNFn(Var vf, const vector<Var>& a) {
         vec<Lit> lits;
         Lit lf = Lit(vf);
         for(size_t i = 0; i < a.size(); i++){
            lits.push(~Lit(a[i])); lits.push(lf);
            _solver->addClause(lits); lits.clear();
         }
         for(size_t i = 0; i < a.size(); i++){
            lits.push( Lit(a[i]));
